...
public class Main {
    public static void main(String[] args){
        ...
        // poll xoá 1 phần tử trong ds
        System.out.println("Poll:"+numbers.poll()+" remain:"+numbers.size());
        System.out.println("Poll:"+numbers.poll()+" remain:"+numbers.size());
        System.out.println("Poll:"+numbers.poll()+" remain:"+numbers.size());

        // sắp xếp ds sinh viên theo điểm thi từ cao đến thấp
        ...
        System.out.println("Tiêu chuẩn làm sv xuất sắc là điểm thi phải đạt:" +hm.get("good_student"));
